...
bool condCheckSector(DBloodActor* pXCond, int cmpOp, bool PUSH);
bool condCheckWall(DBloodActor* pXCond, int cmpOp, bool PUSH);
bool condCheckSprite(DBloodActor* pXCond, int cmpOp, bool PUSH);
