...
x(LifeSeedIcon, 2433)
x(RedPotionIcon, 517)
x(FeatherFallIcon, 783)
x(ShadowCloakIcon, 896)
x(DeathMaskIcon, 825)
x(RavenFlightIcon, 828)
x(GunsAkimboIcon, 829)
x(GasMaskIcon, 831)
x(CloneIcon, 863)
x(DecoyIcon, 836)
x(DoppleIcon, 851)
x(ReflectiveIcon, 2428)
x(UselessIcon, 768)
x(RageShroomIcon, 840)
x(DeliriumIcon, 841)
x(GrowShroomIcon, 842)
x(ShrinkShroomIcon, 843)
x(UselessIcon2, 683)
x(WineGobletIcon, 521)
x(WineBottleIcon, 604)
x(SkullGrailIcon, 520)
x(SilverGrailIcon, 803)
x(TomeIcon, 518)
x(BlackChestIcon, 522)
x(WoodenChestIcon, 523)
x(AsbestIcon, 837)
x(BasicArmorIcon, 2628)
x(SuperArmorIcon, 2594)
x(FlagBaseIcon, 753)
x(FlagIcon, 3558)
