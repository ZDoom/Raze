...
DIGI_ENTRY("BADMAN04.VOC",  DIGI_TAUNTAI1,        246,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("COMEGET2.VOC",  DIGI_TAUNTAI2,        247,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("GHOP07.VOC",    DIGI_TAUNTAI3,        248,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("GOODDAY4.VOC",  DIGI_TAUNTAI4,        249,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("KILLU05.VOC",   DIGI_TAUNTAI5,        250,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("NATURAL4.VOC",  DIGI_TAUNTAI6,        251,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("NOHONOR6.VOC",  DIGI_TAUNTAI7,        252,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("SAYON09.VOC",   DIGI_TAUNTAI8,        253,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("TAKSAN1.VOC",   DIGI_TAUNTAI9,        254,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("SNATCH01.VOC",  DIGI_TAUNTAI10,       255,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
...
DIGI_ENTRY("SWYELL03.VOC",  DIGI_PLAYERYELL1,     261,      PRI_PLAYERSPEECH, -200, 200, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("SWYELL05.VOC",  DIGI_PLAYERYELL2,     262,      PRI_PLAYERSPEECH, -200, 200, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("SWYELL06.VOC",  DIGI_PLAYERYELL3,     263,      PRI_PLAYERSPEECH, -200, 200, 0, DIST_NORMAL, VF_NORMAL)

DIGI_ENTRY("GRUNT06.VOC",   DIGI_SEARCHWALL,      264,      PRI_PLAYERVOICE, -200, 200, 0, DIST_NORMAL, VF_NORMAL)

DIGI_ENTRY("NOWAY1.VOC",    DIGI_NOURINAL,        265,      PRI_PLAYERSPEECH,    0,   0, 0, DIST_NORMAL, VF_NORMAL)

DIGI_ENTRY("SWDIE02.VOC",   DIGI_FALLSCREAM,      266,      PRI_PLAYERDEATH, -100, 100, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("AHSO5.VOC",     DIGI_GOTITEM1,        267,      PRI_PLAYERSPEECH,    0,   0, 0, DIST_NORMAL, VF_NORMAL)
...
// More player voices
DIGI_ENTRY("ACS10.VOC",     DIGI_ANCIENTSECRET,   326,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("AMDRIV01.VOC",  DIGI_AMERICANDRIVER,  327,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("BABOON03.VOC",  DIGI_DRIVELIKEBABOON, 328,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("BBURN04.VOC",   DIGI_BURNBABY,        329,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("BIGWPN01.VOC",  DIGI_LIKEBIGWEAPONS,  330,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("CBUNG01.VOC",   DIGI_COWABUNGA,       331,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("CHARAD09.VOC",  DIGI_NOCHARADE,       332,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("DTIME.VOC",     DIGI_TIMETODIE,       333,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("EAT02.VOC",     DIGI_EATTHIS,         334,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("FCRACK01.VOC",  DIGI_FIRECRACKERUPASS,335,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("HCOW03.VOC",    DIGI_HOLYCOW,         336,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("HCOW06.VOC",    DIGI_HOLYPEICESOFCOW, 337,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("HSHIT03.VOC",   DIGI_HOLYSHIT,        338,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("HSHIT04.VOC",   DIGI_HOLYPEICESOFSHIT,339,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("IHOPE01.VOC",   DIGI_PAYINGATTENTION, 340,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("ILIKE01.VOC",   DIGI_EVERYBODYDEAD,   341,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("KUNGFU06.VOC",  DIGI_KUNGFU,          342,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("LMOVE01.VOC",   DIGI_HOWYOULIKEMOVE,  343,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("LWANG05.VOC",   DIGI_NOMESSWITHWANG,  344,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("RAW01.VOC",     DIGI_RAWREVENGE,      345,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("STUPID01.VOC",  DIGI_YOULOOKSTUPID,   346,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("TDICK02.VOC",   DIGI_TINYDICK,        347,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("TOURN01.VOC",   DIGI_NOTOURNAMENT,    348,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("WWANG11.VOC",   DIGI_WHOWANTSWANG,    349,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("YAK02.VOC",     DIGI_MOVELIKEYAK,     350,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("REFLEX08.VOC",  DIGI_ALLINREFLEXES,   351,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("EVADE01.VOC",   DIGI_EVADEFOREVER,    352,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("MFLY03.VOC",    DIGI_MRFLY,           353,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("SHISEI03.VOC",  DIGI_SHISEISI,        354,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("FWORKS01.VOC",  DIGI_LIKEFIREWORKS,   355,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("HIRO03.VOC",    DIGI_LIKEHIROSHIMA,   356,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("NAGA06.VOC",    DIGI_LIKENAGASAKI,    357,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("PEARL03.VOC",   DIGI_LIKEPEARL,       358,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("IAM01.VOC",     DIGI_IAMSHADOW,       359,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("LIKNUK01.VOC",  DIGI_ILIKENUKES,      360,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("LIKSRD01.VOC",  DIGI_ILIKESWORD,      361,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("LIKSHK02.VOC",  DIGI_ILIKESHURIKEN,   362,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("LUCK06.VOC",    DIGI_BADLUCK,         363,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("MCHAN01.VOC",   DIGI_NOMOVIEMRCHAN,   364,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("RCHAN13.VOC",   DIGI_REALLIFEMRCHAN,  365,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("MUSIC03.VOC",   DIGI_NOLIKEMUSIC,     366,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("NODIFF07.VOC",  DIGI_NODIFFERENCE,    367,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("NOFEAR01.VOC",  DIGI_NOFEAR,          368,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("NOPAIN.VOC",    DIGI_NOPAIN,          369,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("REPMAN15.VOC",  DIGI_NOREPAIRMAN,     370,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("SOB15.VOC",     DIGI_SONOFABITCH,     371,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("WEAK03.VOC",    DIGI_PAINFORWEAK,     372,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("SPEED04.VOC",   DIGI_GOSPEEDY,        373,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("STIFF01.VOC",   DIGI_GETTINGSTIFF,    374,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("TOMB05.VOC",    DIGI_TOMBRAIDER,      375,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("TSTICK01.VOC",  DIGI_STICKYGOTU1,     376,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("TSTICK05.VOC",  DIGI_STICKYGOTU2,     377,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("TSTICK07.VOC",  DIGI_STICKYGOTU3,     378,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("TSTICK10.VOC",  DIGI_STICKYGOTU4,     379,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("TSWORD05.VOC",  DIGI_SWORDGOTU1,      380,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("TSWORD08.VOC",  DIGI_SWORDGOTU2,      381,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("TSWORD01.VOC",  DIGI_SWORDGOTU3,      382,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
...
DIGI_ENTRY("BANZAI1.VOC",  DIGI_BANZAI,           438,      PRI_PLAYERSPEECH,    0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("HAHA19.VOC",   DIGI_HAHA1,            439,      PRI_PLAYERSPEECH,    0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("HAHA11.VOC",   DIGI_HAHA2,            440,      PRI_PLAYERSPEECH,    0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("HAHA15.VOC",   DIGI_HAHA3,            441,      PRI_PLAYERSPEECH,    0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("TELEPT02.VOC", DIGI_ITEM_SPAWN,       442,      PRI_ITEM,           0,      0, 0, DIST_NORMAL, VF_NORMAL)

// More Player Voices
DIGI_ENTRY("JG1075.VOC",   DIGI_NOREPAIRMAN2,     443,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG1082.VOC",   DIGI_NOPOWER,          444,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG1087.VOC",   DIGI_DOUBLEUZI,        445,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG1088.VOC",   DIGI_NOTORDBUNNY,      446,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG1103.VOC",   DIGI_CANBEONLYONE,     447,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG2000.VOC",   DIGI_MIRROR1,          448,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG2005.VOC",   DIGI_MIRROR2,          449,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG2020.VOC",   DIGI_HITTINGWALLS,     450,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG2032.VOC",   DIGI_GOTRAILGUN,       451,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG2053.VOC",   DIGI_RABBITHUMP1,      452,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG2054.VOC",   DIGI_RABBITHUMP2,      453,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG2045.VOC",   DIGI_RABBITHUMP3,      454,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG2087.VOC",   DIGI_RABBITHUMP4,      455,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG2074.VOC",   DIGI_FAGRABBIT1,       456,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG2075.VOC",   DIGI_FAGRABBIT2,       457,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG2078.VOC",   DIGI_FAGRABBIT3,       458,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG3005.VOC",   DIGI_STINKLIKEBABBOON, 459,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG3017.VOC",   DIGI_WHATYOUEATBABY,   460,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG3047.VOC",   DIGI_WHATDIEDUPTHERE,  461,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG3022.VOC",   DIGI_YOUGOPOOPOO,      462,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG6053.VOC",   DIGI_PULLMYFINGER,     463,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG3059.VOC",   DIGI_SOAPYOUGOOD,      464,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG4012.VOC",   DIGI_WASHWANG,         465,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG3070.VOC",   DIGI_DROPSOAP,         466,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG6051.VOC",   DIGI_REALTITS,         467,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG4002.VOC",   DIGI_MSTRLEEP,         468,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG4024.VOC",   DIGI_SEEKLEEPADVICE,   469,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
...
DIGI_ENTRY("JGB023.VOC",   DIGI_MADATCARPET,      492,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JGB020.VOC",   DIGI_JUMPONCARPET,     493,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JGB080.VOC",   DIGI_USEBROKENVEHICLE, 494,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JGB106.VOC",   DIGI_STEPONCALTROPS,   495,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JGB130.VOC",   DIGI_WANGSEESERP,      496,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
...
DIGI_ENTRY("JG41060.VOC",  DIGI_JG41060,          522,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG41075.VOC",  DIGI_JG41075,          523,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG42004.VOC",  DIGI_JG42004,          524,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG42019.VOC",  DIGI_JG42019,          525,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG42021.VOC",  DIGI_JG42021,          526,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG42028.VOC",  DIGI_JG42028,          527,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG42033.VOC",  DIGI_JG42033,          528,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG42034.VOC",  DIGI_JG42034,          529,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG42050.VOC",  DIGI_JG42050,          530,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG42056.VOC",  DIGI_JG42056,          531,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG42061.VOC",  DIGI_JG42061,          532,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG43004.VOC",  DIGI_JG43004,          533,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG43015.VOC",  DIGI_JG43015,          534,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG43019.VOC",  DIGI_JG43019,          535,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG43021.VOC",  DIGI_JG43021,          536,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG44011.VOC",  DIGI_JG44011,          537,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG44014.VOC",  DIGI_JG44014,          538,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG44027.VOC",  DIGI_JG44027,          539,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG44038.VOC",  DIGI_JG44038,          540,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG44039.VOC",  DIGI_JG44039,          541,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG44048.VOC",  DIGI_JG44048,          542,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG44052.VOC",  DIGI_JG44052,          543,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG45014.VOC",  DIGI_JG45014,          544,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG44068.VOC",  DIGI_JG44068,          545,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG45010.VOC",  DIGI_JG45010,          546,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG45018.VOC",  DIGI_JG45018,          547,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG45030.VOC",  DIGI_JG45030,          548,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG45033.VOC",  DIGI_JG45033,          549,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG45043.VOC",  DIGI_JG45043,          550,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG45053.VOC",  DIGI_JG45053,          551,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG45067.VOC",  DIGI_JG45067,          552,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG46005.VOC",  DIGI_JG46005,          553,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG46010.VOC",  DIGI_JG46010,          554,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
...
DIGI_ENTRY("JG9009.VOC",  DIGI_JG9009,            583,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
...
DIGI_ENTRY("JG93030.VOC", DIGI_JG93030,           588,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG94002.VOC", DIGI_JG94002,           589,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
...
DIGI_ENTRY("JG9022.VOC",  DIGI_JG9022,            595,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG9032.VOC",  DIGI_JG9032,            596,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG9038.VOC",  DIGI_JG9038,            597,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG9055.VOC",  DIGI_JG9055,            598,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG9060.VOC",  DIGI_JG9060,            599,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG92055.VOC", DIGI_JG92055,           600,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("ML25032.VOC", DIGI_ML25032,           601,      PRI_PLAYERVOICE, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG92036.VOC", DIGI_JG92036,           602,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG92042.VOC", DIGI_JG92042,           603,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("ML26001.VOC", DIGI_ML26001,           604,      PRI_PLAYERVOICE, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG93000.VOC", DIGI_JG93000,           605,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG93011.VOC", DIGI_JG93011,           606,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG93018.VOC", DIGI_JG93018,           607,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
DIGI_ENTRY("JG93023.VOC", DIGI_JG93023,           608,      PRI_PLAYERSPEECH, 0,      0, 0, DIST_NORMAL, VF_NORMAL)
